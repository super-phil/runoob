...
public class CookieUtils {
     ...
     * @return the cookie
     */
    public static Cookie addCookie(HttpServletResponse response, String name, String value, String path) {
     ...
     * @return Cookies list
     */
    public static List<Cookie> addCookies(HttpServletResponse response, Map<String, String> values, String path, int maxAge) {
